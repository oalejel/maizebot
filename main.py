...
GUI_ENABLED = False # try disabling to compare performance. may need to fix some thread task queueing
...
def main(): 
    ...
    #print(planner.path)
    #path = [(11,20),(16,238),(272,143),(271,323,(90,271),(12,480),(170,480),(140,360),(240,360),]
    path = [(11,20),(5,238),(272,143)]
